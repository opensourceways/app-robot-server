...
go_repository(
    ...
    sum = "h1:mO9MU8O99WX+RM3jekzOV54g9Fo+Nbkk7rgrN1u9irM=",
    version = "v1.3.1",
)
...
go_repository(
    ...
    sum = "h1:gY9ZakXlNWg/i/v5bQBic7VMZ4teq4m89lpiao74p/s=",
    version = "v1.7.1",
)
...
go_repository(
    ...
    sum = "h1:1NQKN1NiQgkqd/2moD6ySP/5CoZQsKa1d3ZhJ44Jpmg=",
    version = "v0.1.5",
)
...
go_repository(
    ...
    sum = "h1:2t0h8NA59dpVQpa5Yh8cIcR6nHAeBIEk0zlLVqfw4N4=",
    version = "v1.63.0",
)
